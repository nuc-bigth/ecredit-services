...
function mapRequest(request) {
  ...
  return {
    ...
    CUSTOMER_CUSTOMER_TYPE_EXTER: request.CUSTOMER_CUSTOMER_TYPE_EXTER || '',
...
const CLONE_FIELDS = [
  ...
  'CUSTOMER_BUSINESS_TYPE_INTER', 'CUSTOMER_CUSTOMER_TYPE_EXTER', 'CUSTOMER_DIRECTORS', 'CUSTOMER_SHAREHOLDERS',
